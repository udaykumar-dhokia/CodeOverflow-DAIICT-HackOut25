...
const Hero = () => {
  ...
  return (
    <section className="flex flex-col lg:flex-row items-start lg:items-stretch justify-between min-h-screen p-4 sm:p-6 lg:p-8 gap-6">
      <div className="flex-1 w-full">
        <div className="block lg:hidden w-full h-[200px] items-center justify-center border border-gray-200 rounded-md bg-gray-50 text-gray-600 text-center text-sm p-4">
          Map view is currently only supported on Desktop.
        </div>

        <div className="hidden lg:block w-full h-[800px] overflow-hidden shadow-lg border border-gray-200 rounded-md transition-transform hover:scale-[1.01] duration-300">
          <MapContainer
      ...
      <div className="flex-1 flex flex-col space-y-6 w-full max-w-full">
        <div className="flex gap-3 justify-center lg:justify-start flex-wrap">
          <button
            ...
            className={`px-5 py-2 w-full sm:w-auto text-center  font-medium transition-all cursor-pointer ${
              activeLayer === 'solar'
        ...
        <div className="bg-white p-6  shadow-sm border border-gray-200">
          {activeLayer === 'solar' ? (
            <>
              <h2 className="font-bold text-lg sm:text-xl text-gray-800 mb-4">
                Solar Stats
              </h2>
        ...
        <div className="overflow-y-auto max-h-[250px] sm:max-h-[350px] lg:max-h-[500px] space-y-3">
          {activeLayer === 'solar' &&
            solars.map((s) => (
              <div
                key={s._id}
